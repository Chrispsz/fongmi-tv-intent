...
public class Setting {
    ...
    public static int getScale() {
        return Prefers.getInt("scale", 1); // 16:9 padrão para TV
    }
    ...
    // PRÉ-CONFIGURADO: Buffer 4 segundos para TV (padrão era 1)
    public static int getBuffer() {
        return Math.min(Math.max(Prefers.getInt("buffer", 4), 1), 10);
    }
    ...
    // PRÉ-CONFIGURADO: Background OFF para TV (padrão era 2/PiP)
    ...
    // PRÉ-CONFIGURADO: Tunnel ON para melhor performance (padrão era false)
    public static boolean isTunnel() {
        return Prefers.getBoolean("tunnel", true);
    }
    ...
    // PRÉ-CONFIGURADO: Preferir AAC para melhor áudio (padrão era false)
    public static boolean isPreferAAC() {
        return Prefers.getBoolean("prefer_aac", true);
    }
